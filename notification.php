      ...
      <blockquote>
         ...
         <div class="well" style="">
            <form class="form form-horizontal" method="post" action="">
               ...
               <div class="form-group">
                  <div class="col-md-3">
                     <button class="btn btn-default btn-block" type="submit" name="addPsikotes" style="text-transform: uppercase;">simpan jadwal</button> 
                  </div>
               </div>
            </form>
         </div>
...
<div class="panel panel-primary">
   <div class="panel-body">
      <blockquote>
         ...
         <div class="well" style="">
            <form class="form form-horizontal" method="post" action="">
               <input type="hidden" name="txt_interviews" value="<?php echo $row['id']; ?>">
               <div class="form-group">
                  <div class="col-md-3">
                     <label for="optionsRadios2">Pilihan Jam ke-1</label>
                  </div>
               ...
               <div class="form-group">
                  <div class="col-md-3">
                     <button class="btn btn-default btn-block" type="submit" name="addInterviews" style="text-transform: uppercase;">simpan jadwal</button> 
                  </div>
               </div>
            </form>
         </div>
...
<div class="panel panel-danger">
   <div class="panel-heading">
      Warning! You Have No power here, Gandalf!
   </div>
</div>
<?php }
   }
